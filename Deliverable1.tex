...
\begin{enumerate}[{BE}1.]
	...
	\item The owner of a course must be able to specify a time period for which a non-evaluational, automated-evaluational, manual-evaluational or course is visible for to all enrolled students.
	\begin{enumerate}[{VP2}.1]
		\item Student Viewpoint
			\begin{enumerate}
