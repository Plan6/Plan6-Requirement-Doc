...
classroom/professional environments
	\item The application shall be appropriate in a professional setting for 
teachers
...
with no more than 2 taps of the screen
	\item The application shall have the main feautures on the main screen where it 
is easy to access
...
application to their native language.
	\item The application shall allow the user to adjust what they want to see on 
the front page of the application.
	\item The application shall allow the user to adjust the order of their class
	\item The application shall allow the user to personalize their home page on 
the app
	\item The application shall allow the admin to change the theme of the 
application to appeal to teachers or students
