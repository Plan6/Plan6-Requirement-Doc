...
well-versed in technology. Teachers should know how to use an Android smartphone 
...
functions of the Android smartphone, albeit at a lower level than teachers and 
...
Android smartphone usage, and are able to preform more advanced tasks such as 
...
% Begin SubSection
The application must run on the native Android platform, as per the project specifications provided.
% End SubSection
