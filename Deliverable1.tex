...
\begin{description}
  ...
  \item [Android] an Unix-based operating system developed by Google Inc. for electronic devices including but not limited to touch-enabled smartphones, tablets, and other portable computing devices.

  \item [Classroom Operations] The set of typical actions performed in a
    classroom.

  \item [CMS] Content Management System. A system capable of hosting, managing and delivering digital
    content to user.
  ...
  \item [Smartphone] An embedded electronic device capable of serving as a
    general purpose, internet-enabled computer in addition to providing mobile telephone
