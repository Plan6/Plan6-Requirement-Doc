...
\begin{description}
  ...
  \item [Course Material] All course content to which students cannot submit
    ...
    limited to .pdf, .ppt or .txt file types. This content may be set visible
    or invisible for a specified duration of time. Non-evaluational content and
    course material are synonymous.
  ...
  \item [Visible] An attribute that can be assigned to a course, course content
    or student content. If assigned to a course, that course becomes open to
    all students for enrolment. If assigned to course content or student
    content, that content is then made available to be viewed to all students
    enrolled within that course.
