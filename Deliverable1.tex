...
This section outlines the purpose and scope of the Erudite-CMS project;
definitions, acronyms and abbreviations used within this document; and an
overview of the contents and organization of this software requirements
document.
...
\begin{itemize}
  ...
  \item Provide an API for retrieving and sending data between the front-end
