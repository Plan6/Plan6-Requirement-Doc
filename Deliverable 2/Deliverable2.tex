...
The content management system is responsible for receiving and displaying 
content to the users. It is connected to the control system which dictates when 
this system is active, and it sends requests to the main control to be forwarded 
to the model for data processing, and to the view for display.

\subsubsection{The Quiz Management System}
The quiz management system is responsible for receiving and displaying 
...
them to the user. It is connected to the control system which dictates when this 
system is active, and it sends requests to the main control to be forwarded to 
the model for data processing, and to the view for display.
...
it sends requests to the main control to be forwarded to the model for data 
processing, and to the view for display.

\subsubsection{The Authentication System}
The authentication system authenticates users login credentials. This system is 
connected to the control system which dictates when this system is active, and 
it sends requests to the main control to be forwarded to the model for data 
processing, and to the view for display.
...
\begin{enumerate}[a)]
  ...
  \end{table}
	...
	\centering
		...
		Knows Main Controller & Void\\
		\hline
		Knows Database Controller & Void\\
		\hline
		Knows Grades Entity & Void \\
		\hline
		Know Authentication Token Entity & Void \\
		\hline
		Knows Content Entity & Void\\
		\hline
		Knows Quiz Entity & Void \\
		\hline
	...
	\centering
		...
		\textbf{Responsibility:} & \textbf{Collaborators:} \\
		\hline
		Knows Model Controller & Void\\
		\hline
		Knows Database Entity & Void\\
		\hline
	...
	\centering
		\begin{tabular}{|p{9cm}|p{3cm}|}
		\hline
		 \multicolumn{2}{|l|}{\textbf{Class Name: View Controller}} \\
		\hline
		\textbf{Responsibility:} & \textbf{Collaborators:} \\
		\hline
		Knows Main Controller & Void\\
		\hline
		Requests Login View & Login View\\
		\hline
		Receive requests & Login View, Grade View, Quiz View, Content View\\
		\hline
		Forward requests & Main Controller \\
		\hline
		Receive and Send username and password pair to Main Controller & Login View, Main Controller \\
		\hline
		\end{tabular}
	\end{table}
