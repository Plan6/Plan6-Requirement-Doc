...
\begin{enumerate}[{BE}1.]	
	\item A teacher wants to add content to a course.
	\begin{enumerate}[{VP1}.1]
		\item Student Viewpoint
			\begin{enumerate}
		...
		\item Teacher Viewpoint
			\begin{enumerate}
				\item Teachers shall be allowed to upload a electronic document.
        \item The system shall provide interface elements that allow the teacher to upload the document.
				\item The teacher shall terminate a time period for which content is available by deleting the file.
        \item The system shall provide interface elements that allow the teacher to delete the file.
			\end{enumerate}
		\item Parent Viewpoint
			\begin{enumerate}
				\item None
